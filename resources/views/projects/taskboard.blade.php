...
@section('action-button')
    @if (
        ...
        <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="lg"
            ...
            data-toggle="tooltip" title="{{ __('Create') }}"><i class="ti ti-plus"></i></a>
    @endif
                                    ...
                                    <div class="card-header">
                                        <div class="float-end">
                                            <button class="btn-submit btn btn-md btn-primary btn-icon px-1  py-0">
                                                <span
                                                    class="badge badge-secondary count">{{ $stage->tasks->count() }}</span>
                                            </button>
                                        </div>
                                            ...
                                            <div class="card" id="{{ $task->id }}">
                                                ...
                                                <div class="position-absolute top-0 start-0 pt-3 ps-3">
                                                    ...
                                                    @elseif($task->priority == 'High')
                                                        <div class="badge bg-danger p-2 px-3">
                                                            {{ $task->priority }}</div>
                                                    @endif
                                                </div>
                        ...
                        success: function(data) {
                            ...
                            if (data.user_type == 'Client') {
                                ...
                                var html = "<li class='media border-bottom mb-3'>" +
                                    ...
                                    "                           </div>" +
                                    "                           <div class='text-end'>" +
                                    "                               <a href='#' class='delete-icon  btn-danger  btn btn-sm delete-comment' data-url='" +
                                    data.deleteUrl + "'>" +
                                    "                                   <i class='ti ti-trash'></i>" +
                                    "                               </a>" +
                                    "                           </div>" +
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var html = '<li class="list-group-item py-3">' +
                            ...
                            '    </div>' +
                            '    <div class="text-end">' +
                            '        <a href="#" class=" btn-danger  btn btn-sm delete-comment delete-icon delete-subtask" data-url="' +
                            data.deleteUrl + '">' +
                            '            <i class="ti ti-trash"></i>' +
                            '        </a>' +
                            '    </div>' +
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.deleteUrl.length > 0) {
                            delLink =
                                "<a href='#' class=' btn-danger  btn btn-sm  delete-icon delete-comment-file'  data-url='" +
                                data.deleteUrl + "'>" +
                                "                                        <i class='ti ti-trash'></i>" +
                                "                                    </a>";
                        }
                        ...
                        var html = "<div class='card mb-1 shadow-none border'>" +
                            ...
                            "' class='edit-icon btn-primary  btn btn-sm '>" +
                            "                   <i class='ti ti-download'></i>" +
                            "               </a>" +
                            "               <a href='{{ $logo_tasks }}/" + data.file +
                            "' class='edit-icon  btn-secondary  btn btn-sm mx-1'>" +
