...
@section('action-button')
    @auth('web')
        <a href="{{ route('project.export') }}" class="btn btn-sm btn-primary " data-toggle="tooltip"
            title="{{ __('Export') }}"> <i class="ti ti-file-x"></i></a>

        <a href="#" class="btn btn-sm btn-primary " data-ajax-popup="true" data-title="{{ __('Import Project') }}"
        ...
        @if (isset($currentWorkspace) && $currentWorkspace->creater->id == Auth::id())
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md"
                data-title="{{ __('Create Project') }}" data-url="{{ route('projects.create', $currentWorkspace->slug) }}"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0">
                                            @if ($project->is_active)
                                                <a href="@auth('web'){{ route('projects.show', [$currentWorkspace->slug, $project->id]) }}@elseauth{{ route('client.projects.show', [$currentWorkspace->slug, $project->id]) }}@endauth"
                                                    title="{{ $project->name }}"
                                                    data-toggle="tooltip">{{ $project->name }}
                                                    <i class="ti ti-eye"></i>
                                                </a>
                                            @else
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    @if ($project->is_active)
                                                        @if ($currentWorkspace->permission == 'Owner')
                                                            ...
                                                            <a href="#" class="dropdown-item" data-ajax-popup="true"
                                                                data-size="lg" data-title="{{ __('Update Project') }}"
                                ...
                                <div class="card-body">
                                    <div class="row g-2 justify-content-between">
                                        ...
                                        @elseif($project->status == 'Ongoing')
                                            <div class="col-auto">
                                                <span class="badge bg-secondary">{{ __('Ongoing') }}</span>
                                            </div>
                                        @else
                                            <div class="col-auto">
                                                <span class="badge bg-warning">{{ __('OnHold') }}</span>
                                            </div>
                                        @endif
                                        <div class="col-auto">
                                    ...
                                    <div class="card mb-0 mt-3 text-center">
                    ...
                    @auth('web')
                        @if (isset($currentWorkspace) && $currentWorkspace->creater->id == Auth::id())
                            <div class="col-xl-3 col-lg-4 col-sm-6 All add_projects">
                                <a href="#" class="btn-addnew-project border-primary" style="padding: 110px 10px;"
                                    data-ajax-popup="true" data-size="md" data-title="{{ __('Create Project') }}"
