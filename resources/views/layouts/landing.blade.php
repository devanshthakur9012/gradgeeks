...
<body class="{{ $color }}">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5 mt-5 pt-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        ...
                        <a href="https://codecanyon.net/item/taskly-project-management-tool/24264721"
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center mb-5  mobile-screen">
                <div class="col-auto">
                    <div class="wow animate__fadeInRight mobile-widget" data-wow-delay="0.2s">
                        ...
                        <img src="{{ $logo . $company_logo }}" alt="" class="img-fluid" />
            ...
            <img src="{{ asset('landing/images/dash.png') }}" alt=""
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('landing/images/dash.png') }}" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('landing/images/img-crm-dash-3.svg') }}" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
            <div class="row align-items-center justify-content-start">
